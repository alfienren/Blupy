...
def dfa_reporting():
    ...
    cfv['Accessories'] = cfv['Accessory (string)'].str.count(',') + 1 # Count number of Accessories in the Plans column
    ...
    cfv['Prepaid Plans'] = np.where((cfv['Plans'] == 0) & (cfv['Services'] == 0), cfv['Devices'], 0)
