...
#     data['Store Locator Visits'] = data[SLV_conversions].sum(axis=1)
#
#     data['Awareness Actions'] = data['Total A Actions'] + data['Total B Actions']
#     data['Consideration Actions'] = data['Total C Actions'] + data['Total D Actions']
#     data['Traffic Actions'] = data['Awareness Actions'] + data['Consideration Actions']
#
#     data['Orders'] = data['Transaction Count']
#
#     data['Video Plays'] = 0
#     data['Video Completes'] = 0
#
#     return data
